...
Aplicou-se o modelo ARIMA com os termos “p”, “d” e “q” com os valores 1, 1 e 1 respectivamente. Assim obteve-se um RMSE (Root Mean Squared Error) de 11%. A determinação dos valores dos termos pode não ser exata, dado que depende da análise,assim, podendo ser incorreta. Assim, entendendo esta dificuldade, utilizou-se a função pmd.arima.auto_arima. Está foi projetada para selecionar o modelo ARIMA ideal. 
